  ...
  <nav class="navbar">
    ...
    <ul class="header-nav">
      <li class="header-nav-item">
        <a class="header-nav-link" href="about.html">О компании</a>
      </li>
      <li class="header-nav-item">
      ...
      <div class="cta-form-wrapper container">
        <form class="cta-form" action="#">
          ...
          <div class="cta-form-footer">
            <button class="button cta-form-button" type="submit" data-toggle="modal">Отправить заявку</button>
  ...
  <footer class="footer">
    <div class="container">
      ...
      <div class="footer-top">
        ...
        <a class="footer-phone" href="tel:+74996861014">+7 (499) 686-10-14</a>
